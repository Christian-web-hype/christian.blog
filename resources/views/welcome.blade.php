    ...
    <div class="row">
      ...
      <div class="col-12 d-flex flex-column align-items-center mt-3">
        <div class="mb-5 d-flex flex-column justify-content-end">
          <img class="pres watch" src="media/homescritta.png" alt="">
        </div>
